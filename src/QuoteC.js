...
var QuoteC = React.createClass({
  ...
  submitQuote: function(e){
    ...
    var procedureListItems = this.props.doctor.procedures.map(function(proc,i) {
        ...
        <Row style={{marginTop:"1em",marginLeft:"0.0em"}}>
          <Col>
            <Button bsSize="small" style={backButtonStyle}
              onClick={this.props.handleBackQuoteClick}>
          ...
          style={{backgroundColor:"#D9D9D9"}}>
            <div style={topBannerStyle}>
              Requesting a Consultation
		        ...
		        <form onSubmit={this.submitQuote} style={formStyle}>
            ...
            <Input type="textarea" ref="questions" placeholder="Questions or Comments"
              style={{backgroundColor:"#F2F2F2"}}/>
